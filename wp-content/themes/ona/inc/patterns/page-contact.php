...
return array(
	...
	'content'    => '
			...
			<main class="wp-block-group is-style-no-spacing"><!-- wp:cover {"url":"' . esc_url( get_theme_file_uri( 'assets/img/ona_contact_background.jpg' ) ) . '","id":254,"hasParallax":true,"dimRatio":50,"minHeight":85,"minHeightUnit":"vh","contentPosition":"center center","isDark":false} -->
			<div class="wp-block-cover is-light has-parallax" style="background-image:url(' . esc_url( get_theme_file_uri( 'assets/img/ona_contact_background.jpg' ) ) . ');min-height:85vh"><span aria-hidden="true" class="wp-block-cover__gradient-background has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"inherit":false,"contentSize":"970px"}} -->
