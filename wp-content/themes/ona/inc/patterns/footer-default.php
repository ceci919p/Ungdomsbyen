...
return array(
	...
	'content'    => '
			...
			<!-- wp:site-title {"textAlign":"center","style":{"typography":{"textTransform":"uppercase","letterSpacing":"18px","fontSize":"40px","lineHeight":"1.5"},"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"className":"ona-site-title","fontFamily":"nunito-sans"} /-->
			...
			<p class="has-text-align-center mb-1 has-text-light-color has-text-color has-tiny-font-size">©2021 Ona, Made by DeoThemes</p>
			<!-- /wp:paragraph -->
