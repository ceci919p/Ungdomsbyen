...
return array(
	...
	'content'    => '
			...
			<div class="wp-block-button has-custom-width wp-block-button__width-50 has-custom-font-size is-style-fill has-nunito-sans-font-family has-tiny-font-size"><a class="wp-block-button__link" href="#" style="padding-top:16px;padding-bottom:16px">' . __( 'FASHION', 'ona' ) . '</a></div>
			<!-- /wp:button --></div>
			<!-- /wp:buttons --></div></div>
			<!-- /wp:cover -->
			...
			<div class="wp-block-buttons is-content-justification-center"><!-- wp:button {"width":50,"style":{"spacing":{"padding":{"top":"16px","bottom":"16px"}}},"className":"is-style-fill","fontSize":"tiny","fontFamily":"nunito-sans"} -->
			<div class="wp-block-button has-custom-width wp-block-button__width-50 has-custom-font-size is-style-fill has-nunito-sans-font-family has-tiny-font-size"><a class="wp-block-button__link" href="#" style="padding-top:16px;padding-bottom:16px">' . __( 'LIFESTYLE', 'ona' ) . '</a></div>
			<!-- /wp:button --></div>
			<!-- /wp:buttons --></div></div>
			<!-- /wp:cover -->
			...
			<div class="wp-block-buttons is-content-justification-center"><!-- wp:button {"width":50,"style":{"spacing":{"padding":{"top":"16px","bottom":"16px"}}},"className":"is-style-fill","fontSize":"tiny","fontFamily":"nunito-sans"} -->
			<div class="wp-block-button has-custom-width wp-block-button__width-50 has-custom-font-size is-style-fill has-nunito-sans-font-family has-tiny-font-size"><a class="wp-block-button__link" href="#" style="padding-top:16px;padding-bottom:16px">' . __( 'TRAVEL', 'ona' ) . '</a></div>
			<!-- /wp:button --></div>
			<!-- /wp:buttons --></div></div>
			<!-- /wp:cover -->
			...
			<div class="wp-block-buttons is-content-justification-center"><!-- wp:button {"width":50,"style":{"spacing":{"padding":{"top":"16px","bottom":"16px"}}},"className":"is-style-fill","fontSize":"tiny","fontFamily":"nunito-sans"} -->
			<div class="wp-block-button has-custom-width wp-block-button__width-50 has-custom-font-size is-style-fill has-nunito-sans-font-family has-tiny-font-size"><a class="wp-block-button__link" href="#" style="padding-top:16px;padding-bottom:16px">' . __( 'STORIES', 'ona' ) . '</a></div>
			<!-- /wp:button --></div>
			<!-- /wp:buttons --></div></div>
			<!-- /wp:cover --></div>
			<!-- /wp:column --></div>
